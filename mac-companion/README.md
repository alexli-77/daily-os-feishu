...
This is a local macOS menu bar prototype for LEO-46. It is intentionally small and optional: it opens the existing Daily OS dashboard, shows service state, triggers existing workflow actions through the local UI API, and reads recent workflow run records.
